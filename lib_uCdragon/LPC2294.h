...
#define CAN1EWL 		(*((volatile unsigned long *) 0xE0044018))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN1SR  		(*((volatile unsigned long *) 0xE004401C))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN1RFS 		(*((volatile unsigned long *) 0xE0044020))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN1RID 		(*((volatile unsigned long *) 0xE0044024))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
...
#define CAN2EWL 		(*((volatile unsigned long *) 0xE0048018))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN2SR  		(*((volatile unsigned long *) 0xE004801C))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN2RFS 		(*((volatile unsigned long *) 0xE0048020))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN2RID 		(*((volatile unsigned long *) 0xE0048024))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
...
#define CAN3EWL 		(*((volatile unsigned long *) 0xE004C018))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN3SR  		(*((volatile unsigned long *) 0xE004C01C))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN3RFS 		(*((volatile unsigned long *) 0xE004C020))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN3RID 		(*((volatile unsigned long *) 0xE004c024))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
...
#define CAN4EWL 		(*((volatile unsigned long *) 0xE0050018))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN4SR  		(*((volatile unsigned long *) 0xE005001C))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN4RFS 		(*((volatile unsigned long *) 0xE0050020))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
#define CAN4RID 		(*((volatile unsigned long *) 0xE0050024))  	/* lpc2119\lpc2129\lpc2292\lpc2294 only */
